...
class AiMapPromptPage extends StatefulWidget {
  const AiMapPromptPage({super.key});

  @override
  State<AiMapPromptPage> createState() => _AiMapPromptPageState();
}

class _AiMapPromptPageState extends State<AiMapPromptPage> {
  ...
  Future<void> _load() async {
    prompts = await AiCoverMapPromptService.fetchByType('map');
    setState(() {});
  }
